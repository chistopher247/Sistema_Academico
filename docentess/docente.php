          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>CHISTOPHER BRAYANS</span>
                <h2>AVENDAÑO PAUCAR</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>CREAR DOCENTE <small>HOLA</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate>
                      ...
                      <span class="section">DOCENTE</span>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">NRO Telefono :
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Condicion Laboral :
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nom_ap" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Id Cargo :
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="cel" maxlength="9" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
